...
if ($checkButton) {
    if($_SESSION['question2'] == 1){ //if question 2 answer = 1, skip section3
        $_SESSION['section2'] = calcScore($totalQues);
        $_SESSION['section3'] = 9;
...
?>
    ...
    <body>
        ...
        <h1>Strategic Management Risks</h1>

        <h2>Investment Portfolio Management</h2>
        <form method="post">
        <?php
$GLOBALS['x'] = 1;
showQuestion($pdo, 19, 19);
?>

        <h2>Investment Portfolio Management</h2>
        <?php
showQuestion($pdo, 20, 20);
?>

        <h2>Project Integration Management</h2>
        <?php
showQuestion($pdo, 21, 21);
?>

<h2>Communications</h2>
        <?php
showQuestion($pdo, 22, 23);
?>

<h2>Project integration management</h2>
        <?php
showQuestion($pdo, 24, 24);
?>
