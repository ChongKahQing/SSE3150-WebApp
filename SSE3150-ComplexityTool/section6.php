...
if ($checkButton) {
   $_SESSION['section6'] = calcScore($totalQues);
...
?>
    ...
    <body>
        ...
        <h1>Project Management Integration Risks</h1>

        <h2>Project integration management</h2>
        <form method="post">
        <?php
$GLOBALS['x'] = 1;
showQuestion($pdo, 44, 44);
?>

<h2>Human resources, Project integration management</h2>
        <?php
showQuestion($pdo, 45,45);
?>

<h2>Project integration management</h2>
        <?php
showQuestion($pdo, 46,46);
?>

<h2>Project integration management, Quality risk</h2>
        <?php
showQuestion($pdo, 47,47);
?>

<h2>Risk</h2>
        <?php
showQuestion($pdo, 48,48);
?>

<h2>Communications</h2>
        <?php
showQuestion($pdo, 49,49);
?>
